        ...
        <div class="container-fluid">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="tabelku" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php echo abs($hasil);?></td>
                                <td class="text-center">
                                    <?php echo $jumlah[0]['jumlah'];?></td>
                                <!-- <td class="text-center">
                                    <a href="<?php echo base_url(); ?>KapasitasKelasBaru/isi/<?= $row['nama']; ?>"
                    ...
                    <?php 
                    $data = ['jumlahTotal'=>$jmlh,'jumlahMengulang'=>$jumlah, 'jumlahBelumMengambil'=> $hasil];
