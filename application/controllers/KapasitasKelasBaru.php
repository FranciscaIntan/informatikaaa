...
class KapasitasKelasBaru extends CI_Controller
{
    ...
    {
        // var_dump($data = $this->session->tempdata('item'));
        // die;
        ...
        foreach ($menu as $m) {
            ...
            $excel->setActiveSheetIndex(0)->setCellValue('D' . $row, $jumlah[0]['jumlah']);
            $excel->setActiveSheetIndex(0)->setCellValue('E' . $row, abs($hasil));
